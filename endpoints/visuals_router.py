...
# @router.get("/visuals/most_frequent_cluster", response_model=list[schemas.SalonVisuals])
# def get_visuals_by_customer_attributes(
#     gender: str = Query(...),
#     age: str = Query(...),
#     income_level: str = Query(...),
...
#     # Get visuals for the most frequent cluster
#     visuals = visuals_crud.get_visuals_by_cluster(db=db, cluster=most_frequent_cluster)

#     if not visuals:
#         raise HTTPException(status_code=404, detail="No visuals found for the most frequent cluster.")
