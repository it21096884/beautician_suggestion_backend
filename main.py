...
from endpoints import admin_router, beautician_router, salon_router, customer_router, preferences_router, appointments_router, review_router, skin_router, visuals_router, skin_colour_router
